...
export const projects = [
	{
		...
		description:
			"Engineered a full-stack student support system using Django and React. Features include a robust backend with user authentication, a PostgreSQL database for university data, and a dynamic front-end with user and admin dashboards. This demonstrates my ability to build and integrate complex end-to-end systems.",
		links: {
	...
	},
	{
		...
		title: "MovieSpot",
		description:
			"Developed a responsive React application that consumes the OMDb REST API to display real-time movie data. This project showcases my ability to work with external APIs, manage application state, and create a dynamic, searchable user interface.",
		links: {
